        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-0 rounded-3 h-100">
                <div class="card-body text-center">
                    ...
                    <small class="text-muted">Registro global del sistema</small>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card shadow-sm border-0 rounded-3 h-100">
                <div class="card-body text-center">
                    ...
                    <p class="text-muted fs-4 fw-bold mt-2 mb-1">{{ $pendientes }}</p>
                    <small class="text-muted">En espera de resolución</small>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card shadow-sm border-0 rounded-3 h-100">
                <div class="card-body text-center">
                    ...
                    <small class="text-muted">Con resolución favorable</small>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card shadow-sm border-0 rounded-3 h-100">
                <div class="card-body text-center">
                    ...
                    <h6 class="fw-semibold mb-0">Documentación</h6>
                    <p class="text-muted fs-4 fw-bold mt-2 mb-1">PDF</p>
                    <small class="text-muted">Emisión y control de fichas</small>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="d-grid gap-3">
                        <a href="{{ route('reportes.mensuales') }}" class="btn btn-outline-primary text-start py-3">
                            <i class="bi bi-bar-chart-line me-2"></i> Revisar solicitudes del establecimiento
                        </a>
                        <a href="{{ route('reportes.mensual') }}?mes={{ now()->month }}&anio={{ now()->year }}" target="_blank" class="btn btn-outline-primary text-start py-3">
                            <i class="bi bi-file-earmark-pdf me-2"></i> Abrir reporte mensual actual
                        </a>
                    </div>

                    <div class="alert alert-info mt-4 mb-0">
                        <i class="bi bi-info-circle me-2"></i>
                        Secretaría administra el seguimiento documental y la consulta global de solicitudes.
                    </div>
                </div>
            </div>
        </div>
