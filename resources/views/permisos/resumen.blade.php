...
<div class="container-fluid py-4">
    ...
    <div class="card shadow-sm border-0 mb-4">
        ...
        <div class="card-body p-0">
            <table class="table table-bordered table-striped mb-0">
                <thead class="table-light">
                    <tr>
                        <th width="14%">F. inicio</th>
                        <th width="14%">F. termino</th>
                        <th width="10%">Días aprobados</th>
                        <th width="10%">Días restaurados</th>
                        <th width="10%">Descuento neto</th>
                        <th>Motivo</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse($conGoce as $p)
                        <tr>
                            ...
                            <td>{{ number_format($p->dias_netos_descontados, 1) }}</td>
                            <td>{{ $p->motivo ?? '-' }}</td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="6" class="text-center text-muted py-3">
                                No registra permisos con goce en el periodo.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
        ...
        <div class="card-footer text-end fw-semibold">
            Total descuento neto: {{ number_format($totalConGoce, 1) }}
        </div>
    </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center text-muted py-3">
                                No registra permisos sin goce en el periodo.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
