...
@section('title', 'Tipos de Solicitud - PermiGest Escolar')

@section('content')
<div class="container-fluid py-4">
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h4 class="fw-bold mb-0">
            <i class="bi bi-list-ul text-primary me-2"></i> Tipos de Solicitud
        </h4>
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#crearTipoModal">
    ...
    <div class="modal-dialog">
        <form class="modal-content" method="POST" action="{{ route('tipos.store') }}">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="crearTipoLabel">Nuevo tipo de solicitud</h5>
