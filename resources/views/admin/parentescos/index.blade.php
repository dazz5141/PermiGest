                            ...
                            <td>
                                ...
                                <form action="{{ route('parentescos.destroy', $p->id) }}" method="POST" class="d-inline">
                                    ...
                                    <button type="submit"
                                            ...
                                            data-confirm
                                            data-confirm-title="¿Eliminar parentesco?"
                                            data-confirm-text="Esta acción eliminará el parentesco de forma permanente."
        ...
        <form class="modal-content" method="POST" action="{{ route('parentescos.store') }}">
            ...
            <div class="modal-footer">
                <button type="submit"
                        ...
                        data-confirm
                        data-confirm-title="¿Registrar nuevo parentesco?"
                        data-confirm-text="Se agregará un nuevo parentesco al sistema."
                        data-confirm-btn="Sí, guardar"
                        data-cancel-btn="Cancelar"
