                            ...
                            <td class="text-end pe-4">
                                ...
                                <form action="{{ route('estados.destroy', $estado->id) }}" method="POST" class="d-inline">
                                    ...
                                    <button type="submit"
                                            ...
                                            data-confirm-text="Esta acción eliminará el estado de forma permanente."
        ...
        <form class="modal-content" method="POST" action="{{ route('estados.store') }}">
            ...
            <div class="modal-footer">
                <button type="submit"
                        ...
                        data-confirm
                        data-confirm-title="¿Registrar nuevo estado?"
                        data-confirm-text="Se agregará un nuevo estado de solicitud al sistema."
